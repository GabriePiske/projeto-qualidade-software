...
Justificativa: elementos importantes para a experiência, mas não impedem o uso básico do sistema.
...
Justificativa: testes unitários são mais rápidos e baratos, permitindo detectar erros cedo. Testes de integração garantem comunicação correta entre componentes. Testes de sistema são mais caros e lentos, então devem ser usados com menor frequência.
